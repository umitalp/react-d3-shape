...
var MultiLineBrushChart = function (_Component) {
    ...
    */
			...
			if (showXGrid) xgrid = _react2.default.createElement(_mhsD3Core.Xgrid, this.props);
			if (showYGrid) ygrid = _react2.default.createElement(_mhsD3Core.Ygrid, this.props);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					chartSeriesType,
					_react2.default.createElement(_mhsD3Core.Xaxis, this.props),
					_react2.default.createElement(_mhsD3Core.Yaxis, this.props),
					xgrid,
					ygrid
				),
